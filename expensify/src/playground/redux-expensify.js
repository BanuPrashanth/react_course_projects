...
const expensesReducer = (state = expensesReducerDefaultState, action) => {
    switch(action.type){
        ...
        case 'REMOVE_EXPENSE':
            return state.filter(id => (id.id !== action.expense.id))
        case 'EDIT_EXPENSE':
...
const getVisibleText = (expenses, {text, sortBy, startDate, endDate}) => {
...
store.subscribe(() => {
    ...
    const visibleText = getVisibleText(state.expenses, state.filters)
